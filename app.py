...
# --- DISEÑO UI EXACTO A LA IMAGEN ---
st.markdown(
    """
    <style>
    /* Fondo estilo pared industrial / concreto oscuro */
    .stApp { 
    ...
    div.stButton > button, div[data-testid="stFormSubmitButton"] > button {
        background: linear-gradient(135deg, #2e261a 0%, #684f2b 50%, #b88e46 100%) !important;
        color: #ffffff !important;
        border-radius: 12px !important;
    ...
    div.stButton > button:hover, div[data-testid="stFormSubmitButton"] > button:hover {
        background: linear-gradient(135deg, #3d3222 0%, #826336 50%, #d4a553 100%) !important;
...
if not st.session_state.autenticado:
    if st.session_state.pantalla == "portada":
        ...
        with col2:
            ...
            # LOGO METÁLICO FLOTANTE SOBRE LA PARED
            st.markdown(
                """
                ...
                <div style="
                    background: rgba(20, 22, 28, 0.85); backdrop-filter: blur(25px);
                ...
                ">
                    <div style="color: #ffffff; font-size: 26px; font-weight: 700; letter-spacing: 0.3px; margin-bottom: 4px;">
                        Welcome <span style="color: #e0a346;">Back</span>
                    </div>
                    <div style="color: #8a94a6; font-size: 12px; margin-bottom: 25px;">
            ...
            st.markdown(
                """
                    ...
                    <div style="color: #7a8290; font-size: 12px; margin-top: 15px;">
                        Don't have an account? <span style="color: #e0a346; font-weight: 600; cursor: pointer;">Sign Up</span>
                    </div>
                </div>
                """,
                unsafe_allow_html=True,
        ...
        with col2:
            ...
            st.markdown(
                ...
                ">
                    ...
                    <div style="font-size: 12px; color: #8a94a6; margin-bottom: 15px;">
                        Sign in to continue your engineering journey
                    </div>
                </div>
                """,
            ...
            with st.form("form_login"):
                st.markdown(
                    "<p style='color: #a0aab8; font-size: 12px; font-weight: 500;"
                    " margin-bottom: 4px;'>📧 Email Address</p>",
                    unsafe_allow_html=True,
                )
                ...
                st.markdown(
                    "<div style='text-align: right; margin-top: -5px; margin-bottom: 15px;'><a style='color: #e0a346; font-size: 11px; text-decoration: none;' href='#'>Forgot Password?</a></div>",
                    unsafe_allow_html=True,
                )
